...
# Skype Animation Example

Your mission, should you choose to accept it, is to build the Skype loading animation using C4. This is what the animation looks like:
